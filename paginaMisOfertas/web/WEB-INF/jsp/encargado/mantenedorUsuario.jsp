            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="active"><a href="mantenedorUsuario.html">Usuario</a></li>
                        <li><a href="mantenedorEmpresa.html">Empresa</a></li>
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny">
                                ...
                                <tr>
                                    ...
                                    <td><br>Jared Aguilera</td>
                                    <td><br>hkm</td>
                                    <td><br>jaredaguilera@gmail.com</td>
